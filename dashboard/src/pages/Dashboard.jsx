                ...
                <nav style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '8px' }}>
                    ...
                    {profile?.role === 'admin' && (
                        <div
                            ...
                            style={{ background: activeView === 'admin' ? 'rgba(99, 102, 241, 0.1)' : 'none', color: activeView === 'admin' ? 'var(--primary)' : 'var(--text-muted)', display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', borderRadius: '12px', fontWeight: 600, cursor: 'pointer' }}
                        >
